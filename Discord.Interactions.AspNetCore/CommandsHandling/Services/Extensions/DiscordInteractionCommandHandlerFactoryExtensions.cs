...
namespace TehGM.Discord.Interactions.CommandsHandling
{
    ...
    public static class DiscordInteractionCommandHandlerFactoryExtensions
    {
        ...
        /// <param name="factory">Commands factory to add the handler to.</param>
        /// <param name="commandID">ID of the command.</param>
        /// <param name="instance">Instance of the handler to add.</param>
        public static void AddSingletonCommand(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID, IDiscordInteractionCommand instance)
        ...
        /// <param name="factory">Commands factory to add the handler descriptor to.</param>
        /// <param name="commandID">ID of the command.</param>
        /// <typeparam name="THandler">Type of the handler to register as a new descriptor.</typeparam>
        public static void AddSingletonCommand<THandler>(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID) where THandler : class, IDiscordInteractionCommand
        ...
        /// <param name="commandID">ID of the command.</param>
        /// <typeparam name="THandler">Type of the handler to register as a new descriptor.</typeparam>
        public static void AddScopedCommand<THandler>(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID) where THandler : class, IDiscordInteractionCommand
        ...
        /// <param name="commandID">ID of the command.</param>
        /// <typeparam name="THandler">Type of the handler to register as a new descriptor.</typeparam>
        public static void AddTransientCommand<THandler>(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID) where THandler : class, IDiscordInteractionCommand
        ...
        /// <param name="factory">Commands factory to create the command handler with.</param>
        /// <param name="commandID">ID of the command.</param>
        ...
        public static IDiscordInteractionCommand CreateCommand(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID, IServiceProvider services)
        {
            ServiceDescriptor descriptor = factory.GetDescriptor(commandID);
            if (descriptor == null)
                return null;
            return factory.CreateCommand(descriptor, services);
        }
    }
}
