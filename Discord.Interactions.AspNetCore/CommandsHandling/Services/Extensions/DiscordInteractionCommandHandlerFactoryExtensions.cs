...
namespace TehGM.Discord.Interactions.CommandsHandling
{
    ...
    public static class DiscordInteractionCommandHandlerFactoryExtensions
    {
        ...
        public static IDiscordInteractionCommandHandler CreateCommand(this IDiscordInteractionCommandHandlerFactory factory, ulong commandID, IServiceProvider services)
        {
