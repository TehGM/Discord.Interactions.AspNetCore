...
namespace TehGM.Discord.Interactions.CommandsHandling.Services
{
    ...
    /// <remarks><para>This service is designed to be a part of <see cref="DiscordInteractionCommandsProvider"/>.
    ...
    public class DiscordInteractionCommandHandlerCache : Dictionary<ulong, IDiscordInteractionCommand>, IDisposable
    {
